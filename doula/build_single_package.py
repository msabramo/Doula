...
job_dict = {
    'package_name': 'dummycode',
    'remote': 'git@code.corp.surveymonkey.com:devmonkeys/dummycode.git',
    'branch': 'test',
    'version': '2.8.07-test'
}
...
# Fatal error: local() encountered an error (return code 1) while executing 'python setup.py sdist upload -r http://yorick.corp.surveymonkey.com:9003/simple'
