...
def js_script(ctx, js_files, js_file_name = ''):
    ...
    # alextodo, need to see about getting sub folders too
...
# todo, orgnize all the functions into logic order
# the only global functions should be this and 
...
if __name__ == '__main__':
    ...
    print 'Minifying ...'
    # alextodo add logging to this function, would be cool to see what is going on
    # what getting minifed and where
