...
class ServiceConfigDALTests(unittest.TestCase):
    ...
    def test_update_service_config_data(self):
        ...
        self.assertTrue(sc_dal.latest_service_config('mt1', 'billweb'))
        self.assertTrue(sc_dal.latest_service_config('mt2', 'billweb'))
        self.assertTrue(sc_dal.latest_service_config('mt3', 'billweb'))
